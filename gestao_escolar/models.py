...
class Professor(models.Model):
    ...
    email = models.CharField(max_length=50, default='admin@admin.com')
...
class Curso(models.Model):
    ...
    coordenador = models.CharField(max_length=50, default='Coordenador Padrão')  
    email = models.EmailField(max_length=50, default='admin@admin.com')  
